...
public class ClienteDAO implements DAO<Cliente> {
    ...
    public Cliente buscaID(Cliente dado) throws SQLException {
        cliente = null;
        //Comando SELECT
        String sql = "SELECT * FROM Proprietario WHERE id_cliente = ?";
    ...
    @Override
    public Cliente buscaAvancada(Cliente dado) throws SQLException {
        ClienteDAO dao = new ClienteDAO();
        
        cliente = null;
        //Comando SELECT
        String sql = "SELECT id_cliente, nome, email, cpf, endereco from cliente";
